...
export default function FindRunPage() {
  ...
  const fetchRuns = () => {
    ...
    // NEXT: Replace with actual API fetch
    // await fetch('/api/filter-runs', { method: 'POST', body: JSON.stringify(...) })
  };
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{ marginBottom: '40px', textAlign: 'center' }}>
          <p style={{ fontSize: '18px', color: '#4B5563' }}>
            Browse available runs submitted by other users. Each run includes a location, distance,
            pace, and estimated difficulty. Use the filters below to find runs that match your
            preferences.
          </p>
        </div>
